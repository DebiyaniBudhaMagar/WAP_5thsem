...
function saveUserData() {
    ...
    UpdateTranscript(user_object); // Update transcript section
...
function displayAllUsers() {
    show_data.innerHTML = "";
    const totalUsers = parseInt(localStorage.getItem("counter")) || 0; // Get total users
...
// Event Listeners
btn_submit.addEventListener("click", saveUserData); // Submit button
btn_output.addEventListener("click", displayAllUsers); // Show all users button